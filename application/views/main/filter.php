        ...
        <div class="sticky shadow">
            <div class="sticky-body p-4 text-center">
                ...
                <div class="edit_notes">
                    ...
                    <a href="#" data-toggle="modal" data-target="#ModalCenter<?= $notes[$i]['id'] ?>"><i
                                class="fas fa-times"></i></a>
                </div>
                <div class="d-flex justify-content-end">
                    <div>
                        <span class="date">Date: <?= date('g:i a \o\n l jS F Y',
                                strtotime($notes[$i]['created_at'])) ?></span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a style="text-decoration: none; color: white" href="/delete?id=<?= $notes[$i]['id'] ?>">
